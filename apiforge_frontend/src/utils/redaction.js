/**
 * Centralized Redaction & Sensitive-Data Protection Utilities for APIForge (Client)
 * 
 * Provides consistent, deterministic redaction of sensitive credentials across
 * UI displays, Command Center search indices, Canvas node previews, and error feedback.
 */
...
export function isSensitiveQueryParam(paramName) {
  ...
  return SENSITIVE_PARAM_REGEX.test(paramName.trim());
}
